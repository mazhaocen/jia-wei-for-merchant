  ...
  <div class="send-address" >
    ...
    <section class="content" style="background-color: #efefef">
      <ul class="send-address-list cl">
        <li><p>发货人</p><input type="text" value="李桥乡"></li>
        <li><p>手机号码</p><input type="text" value="13500012345"></li>
        <li><p>邮政编码</p><input type="text" value="518000"></li>
        <li @click="chooseAddress"><p>地址</p><span v-if="!province">{{selectAddress}}</span><span v-if="province">{{province}}{{city}}{{country}}</span></li>
        <!--<li><p>城市</p><span>深圳</span></li>-->
        <!--<li><p>地区</p><span>南山区</span></li>-->
        <li><textarea placeholder="请输入具体地址" v-model="inputAddress"></textarea></li>
      </ul>
      <!--<el-picker :slots="addressSlots" @change="onValuesChange"></el-picker>-->
    </section>
    <footer>
